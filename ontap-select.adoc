...
[.lead]
We recently added content for ONTAP Select. The content can help you with ONTAP Select running on VMware ESXi, and it provides hypervisor-independent documentation for using the ONTAP Select Deploy REST API.
